...
const skills = [
	...
	},
	{
		comfortable: [
			...
			{ skill: 'Firebase', percentage: '45%' },
			{ skill: 'React Hook Form', percentage: '90%' },
			{ skill: 'Redux', percentage: '45%' },
			{ skill: 'MySQL', percentage: '10%' },
		],
	},
	{
		familiars: [
			{ skill: 'Firebase', percentage: '85%' },
			{ skill: 'D3 Chart', percentage: '35%' },
			{ skill: '​Git', percentage: '90%' },
			{ skill: 'Heroku', percentage: '30%' },
			{ skill: 'Netlify', percentage: '30%' },
			{ skill: 'Adobe Photoshop', percentage: '45%' },
			{ skill: 'Adobe Illustrator', percentage: '25%' },
		],
	},
];
const Skills = () => {
